...
Write-Host 'AskYourDoubt Global Rebuild 1.4.1 - Session Stability and Premium Login' -ForegroundColor Cyan
Write-Host '=======================================================' -ForegroundColor Cyan
...
Write-Host 'Installing session-stability fix and premium teacher/student UI...'
...
Write-Host ''
Write-Host 'VERSION 1.4.1 INSTALLED. CORE QA PASSED.' -ForegroundColor Green
Write-Host "Application: $Target"
Write-Host "Evidence: $QaRoot"
Write-Host "Start: $Target\start_local.bat"
Write-Host "Full browser QA: $Target\RUN_FULL_QA_1_4_1.bat"
Write-Host ''
Write-Host 'Firefox and WebKit are only PASS after RUN_FULL_QA_1_4_1.bat succeeds on this Windows machine.' -ForegroundColor Yellow

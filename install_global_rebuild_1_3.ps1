...
Write-Host 'AskYourDoubt Global Rebuild 1.3 - Light 3D Experience' -ForegroundColor Cyan
Write-Host '=======================================================' -ForegroundColor Cyan
...
Write-Host 'Installing application code and Light 3D UI...'
$ExcludedTopLevel = @('device_test_results','.pytest_cache','test_results','database.db','__pycache__')
...
Write-Host ''
Write-Host 'VERSION 1.3 INSTALLED. CORE QA PASSED.' -ForegroundColor Green
Write-Host "Application: $Target"
Write-Host "Evidence: $QaRoot"
Write-Host "Start: $Target\start_local.bat"
Write-Host "Full browser QA: $Target\RUN_FULL_QA_1_3.bat"
Write-Host ''
Write-Host 'Firefox and WebKit are only PASS after RUN_FULL_QA_1_3.bat succeeds on this Windows machine.' -ForegroundColor Yellow
